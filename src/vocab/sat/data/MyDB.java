...
public class MyDB {
	...
	public long insertdiary(String title, String content)
	{
		try{
			...
			Log.v("Insert into databse exception caught", ex.getMessage());
			return -1;
		}
	}
	...
	public long insertUserCreatedList(String title, int content)
	{
		try{
			ContentValues newTaskValue = new ContentValues();
			newTaskValue.put(Constants.TITLE_NAME, title);
	...
	public Cursor getUserCreatedList()
	{
		Cursor c = db.query(Constants.TABLE_NAME2, null, null, null, null, null, null);
		return c;
	}
